...
| ⚙️ | **Econometría II** | Extensiones del modelo lineal, variables limitadas, series de tiempo y datos panel. |
...
├── 🖥️ presentaciones/      # material de clase
